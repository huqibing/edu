...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">作品管理</a><span class="crumb-step">&gt;</span><span>添加学员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath }/stu/addstu.do"  id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <tr>
                                <th><i class="require-red">*</i>学员学号</th>
                                <td>
                                    <input class="common-text required" id="title" name="attribute1" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            <th>性别：</th>
                            <td>
                                <select name="stu_sex" id="catid" class="required">
                                    <option>请选择</option>
                                    <option>男</option>
                                    <option>女</option>
                                </select>
                            ...
                            <tr>
                                <th>年龄：</th>
                                <td><input class="common-text" name="stu_age" size="50" value="" type="text"></td>
                            </tr>
                           <tr>
                                <th>联系电话：</th>
                                <td><input class="common-text" name="stu_phon" size="50" value="" type="tel"></td>
                            </tr>
                             <tr>
                                <th></th>
                                <td>
