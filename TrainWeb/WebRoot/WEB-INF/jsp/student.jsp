...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">学员管理</span></div>
        </div>
            ...
            <form name="myform" id="myform">
                <div class="result-title">
                    <div class="result-list">
                        <a href="jump.do?target=addstudent"><i class="icon-font"></i>新增学员</a>
