...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">作品管理</a><span class="crumb-step">&gt;</span><span>修改学员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath }/stu/updatestudent.do" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                <th><i class="require-red">*</i>修改学员的学号</th>
                                <td>
                                    <input type="text" name="attribute1" value="<%=request.getParameter("id")%>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>年龄：</th>
                                <td><input class="common-text" name="stu_age" size="50"  type="text"></td>
                            </tr>
                           <tr>
                                <th>联系电话：</th>
                                <td><input class="common-text" name="stu_phon" size="50" type="tel"></td>
                            </tr>
                             <tr>
                                <th></th>
                                <td>
